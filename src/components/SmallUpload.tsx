    ...
    >
      ...
      >
        <Center flexDirection="column" w={{ base: '100%', md: '100%' }} h="250px" borderRadius="12px" border="2px dashed rgba(47, 128, 236, 1)">
          ...
          <Button display="flex" alignItems="center" fontSize={{ base: '12px', md: '16px' }} bg={'rgba(47, 128, 236, 1)'} _hover={{ bg: 'rgba(0, 85, 160, 1)' }} leftIcon={<AiOutlinePlusCircle />} w={{ base: '90px', md: '128px' }} h={{ base: '25px', md: '35px' }}>Add File</Button>
        </Center>
      </Box>
    </Box>
  );
