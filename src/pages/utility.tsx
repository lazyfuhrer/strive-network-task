        ...
        <Box pl={5} pr={5} mt={4}>
          <Flex alignItems="center" gap="2" mb={3}>
            <Flex p="2" gap={4}>
              ...
              <Text fontSize={{ base: "16px", md: "36px" }} fontWeight={600}>
                View Utility
              </Text>
            </Flex>
            <Spacer />
          ...
          <Box
            ...
            w={"full"}
            h={{ base: "460px", md: "371px" }}
          >
            <Stack p={7}>
              <Box>
                <Image src="/images/ape.svg" alt="bored ape" />
                <Box w={"full"} pt={2}>
                  <Text pb={2} fontSize={"24px"} fontWeight={600}>
                    MAYC Collection
                  </Text>
                  <Flex
                    px={1}
