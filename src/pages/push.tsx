...
export default function Push() {
  return (
    <Box pl={10} pr={10} pt={7} pb={{ base: 5, md: 0 }}>
      <Text
        fontSize={{ base: "31px", md: "40px" }}
        fontWeight={700}
        style={{
          background: "linear-gradient(90deg, #02AAB0 30.18%, #00CDAC 95.88%)",
        ...
        <Stack direction={{ base: "column", md: "row" }}>
          ...
          <Box flex={{ base: 1, md: "none" }} pl={{ base: 0, md: 10 }}>
            ...
            <Flex justifyContent="space-between" alignItems="center">
              <Text fontSize={"14px"} fontWeight={500} w={"159px"}>
                Don’t have the channel? Create one here...
              </Text>
              <Button
                borderRadius={"8px"}
                w={"148px"}
                h={"35px"}
                bgColor={"rgba(2, 170, 176, 0.3)"}
