    ...
    >
      ...
      >
        <Box w={{ base: "100%", md: "50%" }} mt={-5}>
          ...
          <Text mt={4} fontSize={{ base: "16px", md: "18px" }} fontWeight={500}>
            <Box maxW={{ base: "100%", md: "497px" }} width="100%">
              Biconomy integration into your smart contract enables your
              community to make gasless transactions and helps you provide a
              better user experience. Fill in the gas fee in your gas section to
              enable this function in your next steps. Give your dapp a name
              (for your reference) and verify the other fields before you create
              the dapp.
            </Box>
          </Text>
        </Box>
